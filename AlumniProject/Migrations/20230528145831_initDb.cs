    ...
    public partial class initDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AlumniSchool", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AlumniSchool_Alumni_AlumniId",
                        column: x => x.AlumniId,
                        principalTable: "Alumni",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AlumniSchool_School_SchoolId",
                        column: x => x.SchoolId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AlumniRole", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AlumniRole_Alumni_AlumniId",
                        column: x => x.AlumniId,
                        principalTable: "Alumni",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AlumniRole_Role_RoleId",
                        column: x => x.RoleId,
                        principalTable: "Role",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AlumniRole_AlumniId",
                table: "AlumniRole",
                column: "AlumniId");

            migrationBuilder.CreateIndex(
                name: "IX_AlumniRole_RoleId",
                table: "AlumniRole",
                column: "RoleId");

            migrationBuilder.CreateIndex(
                name: "IX_AlumniSchool_AlumniId",
                table: "AlumniSchool",
                column: "AlumniId");

            migrationBuilder.CreateIndex(
                name: "IX_AlumniSchool_SchoolId",
                table: "AlumniSchool",
                column: "SchoolId");
